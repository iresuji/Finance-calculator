...
choose_calculations=(input('''investment - to calculate the amount of interest you'll earn on your investment
...
if choose_calculations  != "investment" or choose_calculations != "bond":
    print("Please enter a valid value")
    
    

if choose_calculations == "investment": # Use lower to make output lowercase
...
if choose_calculations == "investment" and interest_type == "simple":
        simple_interest=user_amount*(1 + (user_interest/100)*user_years_investment)
        print(f"Your interest is {simple_interest}")
    
elif choose_calculations == "investment" and interest_type == "compound":
